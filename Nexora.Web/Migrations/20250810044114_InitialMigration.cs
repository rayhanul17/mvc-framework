...
namespace Nexora.Web.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Area = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Controller = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewValues = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Changes = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogArchives", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LogArchives_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedToId = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AssignedById = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TicketNotifications_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LogArchives_ArchivedAt",
                table: "LogArchives",
                column: "ArchivedAt");

            migrationBuilder.CreateIndex(
                name: "IX_LogArchives_EntityId",
                table: "LogArchives",
                column: "EntityId");

            migrationBuilder.CreateIndex(
                name: "IX_LogArchives_LoggedAt",
                table: "LogArchives",
                column: "LoggedAt");

            migrationBuilder.CreateIndex(
                name: "IX_LogArchives_TableName",
                table: "LogArchives",
                column: "TableName");

            migrationBuilder.CreateIndex(
                name: "IX_LogArchives_TableName_EntityId",
                table: "LogArchives",
                columns: new[] { "TableName", "EntityId" });

            migrationBuilder.CreateIndex(
                name: "IX_LogArchives_UserId",
                table: "LogArchives",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Logs_TableName_EntityId",
                table: "Logs",
                columns: new[] { "TableName", "EntityId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketNotifications_CreatedAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketNotifications_UserId_IsRead",
                table: "TicketNotifications",
