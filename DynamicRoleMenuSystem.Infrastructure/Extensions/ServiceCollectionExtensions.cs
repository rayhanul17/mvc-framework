...
using DynamicRoleMenuSystem.Infrastructure.Repositories;

namespace DynamicRoleMenuSystem.Infrastructure.Extensions;
...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        services.AddDbContext<ApplicationDbContext>(options =>
            options.UseMySql(
                ...
                mySqlOptions => mySqlOptions.MigrationsAssembly("DynamicRoleMenuSystem.Web")
            ));
    ...
    {
        var applicationAssembly = Assembly.Load("DynamicRoleMenuSystem.Application");
